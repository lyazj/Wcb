...
proc_color = {
    ...
    "Wcs": list(plt.rcParams["axes.prop_cycle"])[1]["color"],
    "Wud": list(plt.rcParams["axes.prop_cycle"])[2]["color"],
    "WOther": list(plt.rcParams["axes.prop_cycle"])[3]["color"],
    "Other": list(plt.rcParams["axes.prop_cycle"])[4]["color"],
}
proc_cut = {
    ...
    "Wcb": [lambda ev: ev["AK8Jet_isWcb"][..., 0]],
    "Wcs": [lambda ev: ev["AK8Jet_isWcs"][..., 0]],
    "Wud": [lambda ev: ev["AK8Jet_isWud"][..., 0]],
    "WOther": [lambda ev: ev["AK8Jet_isWOther"][..., 0]],
    "Other": [lambda ev: ev["AK8Jet_isOther"][..., 0]],
}
plot_list = [

...
proc_match["ttWcb"] = {
    "Data": {
        ...
        "2017": [
            ...
            "SingleElectron_Run2017E-UL2017_MiniAODv2-v1.new.parquet",
            "SingleElectron_Run2017F-UL2017_MiniAODv2-v1.new.parquet",
            "SingleMuon_Run2017B-UL2017_MiniAODv2-v1.new.parquet",
            "SingleMuon_Run2017C-UL2017_MiniAODv2-v1.new.parquet",
            "SingleMuon_Run2017D-UL2017_MiniAODv2-v1.new.parquet",
            "SingleMuon_Run2017E-UL2017_MiniAODv2-v1.new.parquet",
            "SingleMuon_Run2017F-UL2017_MiniAODv2-v1.new.parquet",
        ],
        "2018": [
...
for year in year_match:
    for mode in modes:
        for i, (n, l, ex, b, e, s) in enumerate(plots[mode]):
            ...
            plt.tight_layout()
            plt.savefig(os.path.join(outdir, f"new_parquet_{year}_{mode}_{n}.pdf"))
            plt.clf()

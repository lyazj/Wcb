...
python Condor.py --DAS DAS_ttWcb_sig_2016APV --Filesjson "./json/DAS_ttWcb_sig_2016APV.json" --createfilejson &
python Condor.py --DAS DAS_ttWcb_bkg_2016APV --Filesjson "./json/DAS_ttWcb_bkg_2016APV.json" --createfilejson &
wait

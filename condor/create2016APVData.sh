...
for ERA in B1 B2 C D E F; do
    ...
    python Condor.py --DAS DAS_2016APV${ERA}_SingleElectron --Filesjson "./json/DAS_2016APV${ERA}_SingleElectron.json" --outputPath "/eos/user/l/legao/NtupleStore/V0/2016APV/Data" --year 2016APV --excutable "exe_CUSTNANO_UL16_MINIAODv2_DATA.sh" --TaskFolder "production/NanoNtupleChain_20_Sep_2024" --submitsh "NanoNtupleChain_20_Sep_2024.sh" --Condor --AddtionalArgs "-a '-o ./ -d --year UL2016_preVFP${ERA:0:1}'"
done

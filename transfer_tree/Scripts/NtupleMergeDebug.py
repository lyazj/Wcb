...
root_dir_Splitted="/data/bond/zhaoyz/Ntuple/Wcb_V1/Splitted/" + options.year + "/" + options.type + "/"           # Your dir for Tree file after TransferTree, waiting for changing.         # Your dir for Tree file after TransferTree, waiting for changing.
Ntuple_MERGED="/data/bond/zhaoyz/Ntuple/Wcb_V1/Merged/" + options.year + "/" + options.type + "/"

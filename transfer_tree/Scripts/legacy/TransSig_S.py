...
path_tree ="/data/bond/lyazj/Tree/Wcb_V1/Splitted/" + options.year + "/MC/" # Your dir for Ntuple file waiting for TransferTree,waiting for changing.
...
if options.year == "2017" or options.year == "2018":
    ...
    if options.year == "2016":
        file_dir2='/data/bond/zhaoyz/Ntuple/V3/2016APV/Merged/Signal/'
        for process in process_dict:
            for das in os.listdir(file_dir1):
                if process in das:
                    nEvents_all=0; 
    ...
    if options.year == "2016APV":
        for process in process_dict:
            file_dir2='/data/bond/zhaoyz/Ntuple/V3/2016/Merged/Signal/'
            for das in os.listdir(file_dir1):
                if process in das:
                    nEvents_all=0; 
                    for file in os.listdir(file_dir1+das+'/'):
